...
public class Main extends Application
{
    ...
    public Image tipsIcon = new Image(getClass().getResource("resources/tips.png").toExternalForm());
    public Image questionIcon = new Image(getClass().getResource("resources/question.png").toExternalForm());
